    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 rounded-5 shadow-lg overflow-hidden">
            <div class="row g-0">
                <!-- Left Side: Branding -->
                <div
                    class="col-md-5 d-none d-md-flex authentication-sidebar flex-column justify-content-center p-5 text-white">
                    <div class="mb-4">
                        <i class="fas fa-shopping-bag fa-3x mb-3"></i>
                        <h3 class="fw-bold">Khoa Quyên Store</h3>
                        <div class="header-line"></div>
                    </div>
                    <p class="opacity-75 lead small mb-5">Đăng nhập để tận hưởng tối ưu trải nghiệm mua sắm và theo dõi
                        đơn hàng dễ dàng.</p>
                ...
                <div class="col-md-7 p-4 p-md-5 bg-white position-relative">
                    ...
                    <div id="loginFormSection">
                        ...
                        <form id="ajaxLoginForm" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="mb-4">
                                <div class="d-flex justify-content-between mb-1">
                                    ...
                                    <a href="{{ route('password.request') }}"
                                        class="extra-small text-decoration-none">Quên mật khẩu?</a>
                                </div>
                                <div class="input-group border rounded-3 overflow-hidden bg-light">
                                    <span class="input-group-text bg-transparent border-0"><i
                            ...
                            <button type="submit"
                                class="btn btn-primary-custom w-100 py-3 rounded-pill fw-bold mb-4 shadow-sm">ĐĂNG NHẬP
                                NGAY</button>
                            <p class="text-center small mb-0">Chưa có tài khoản? <a href="javascript:void(0)"
                                    class="fw-bold text-primary-color text-decoration-none"
                                    onclick="toggleAuthForm('register')">Đăng ký mới</a></p>
                        </form>
                    </div>
                    ...
                    <div id="registerFormSection" style="display: none;">
                        ...
                        <div class="d-flex gap-2 mb-3">
                            <button type="button" class="btn btn-sm btn-outline-primary rounded-pill px-3 active"
                                id="btnRegEmail" onclick="setRegType('email')">Dùng Email</button>
                            <button type="button" class="btn btn-sm btn-outline-primary rounded-pill px-3"
                                id="btnRegPhone" onclick="setRegType('phone')">Dùng Số điện thoại</button>
                        </div>
                        ...
                        <form id="ajaxRegisterForm" action="{{ route('register') }}" method="POST">
                            ...
                            <div id="regStep1">
                                ...
                                <div id="phoneField" style="display: none;">
                                    <div class="mb-3">
                                        <label class="form-label extra-small fw-bold text-uppercase">Số điện
                                            thoại</label>
                                        <div class="input-group border rounded-3 overflow-hidden bg-light">
                                            <span class="input-group-text bg-transparent border-0"><i
                                ...
                                <button type="button"
                                    class="btn btn-primary-custom w-100 py-3 rounded-pill fw-bold mb-4 shadow-sm"
                                    onclick="goToStep2()">TIẾP TỤC</button>
                            </div>

                            @include('client.partials.modals.otp-step')

                            <p class="text-center extra-small mb-0">Đã có tài khoản? <a href="javascript:void(0)"
                                    class="fw-bold text-primary-color text-decoration-none"
                                    onclick="toggleAuthForm('login')">Đăng nhập ngay</a></p>
                        </form>
                    </div>
                    ...
                    <script>
                        ...
                        function goToStep2() {
                            ...
                            const identifier = type === 'email' ? document.getElementById('regEmail').value : document.getElementById(
                                'regPhone').value;
