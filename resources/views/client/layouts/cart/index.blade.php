                ...
                <div class="bg-white p-4 rounded-4 shadow-sm h-100">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="form-check">
                            ...
                            <label class="form-check-label fw-bold small text-secondary" for="selectAll">Chọn tất cả</label>
                        </div>
                        <button type="button" class="btn btn-link text-danger text-decoration-none small fw-bold" id="btnClearCart">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr class="align-middle border-bottom border-light cart-row" data-id="{{ $item['id'] }}" data-price="{{ $item['price'] }}">
                                    <td>
